@php
    ...
    $nextActionLabel = match (true) {
        ...
        $detailStatus === 'PREPARING_RELEASE' && (bool) $custody->pickup_expired_at => 'Process the missed pickup',
        $detailStatus === 'PREPARING_RELEASE' && ! $hasPickupSchedule => 'Confirm the system Pickup / Issuance schedule',
