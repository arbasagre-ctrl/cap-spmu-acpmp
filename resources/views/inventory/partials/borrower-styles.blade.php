...
.borrower-inventory-card { padding: 17px 18px; border: 1px solid var(--border); border-radius: 12px; background: var(--surface-elevated); }
...
.borrower-inventory-card input, .borrower-inventory-card select { width: 100%; min-height: 44px; border-radius: 9px; font-size: 12px; }
...
.borrower-inventory-page-size select { min-height: 40px; width: auto; min-width: 160px; padding: 8px 36px 8px 13px; border: 1px solid var(--border); border-radius: 9px; background-color: var(--surface-elevated); color: var(--heading); font-size: 12px; font-weight: 650; }

/* Table */
.borrower-inventory-table-wrap { border: 1px solid var(--border); border-radius: 12px; background: var(--surface-elevated); }
...
.borrower-item-id { display: inline-flex; align-items: center; justify-content: center; min-height: 28px; padding: 4px 9px; border: 1px solid var(--border); border-radius: 9px; background: var(--surface-subtle); color: var(--heading); font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace; font-size: 11px; font-weight: 700; white-space: nowrap; }
...
.borrower-inventory-page { display: inline-flex; align-items: center; justify-content: center; gap: 6px; min-width: 36px; height: 38px; padding: 6px 11px; border: 1px solid var(--border); border-radius: 9px; background: var(--surface-elevated); color: var(--text-secondary); font: inherit; font-size: 12px; font-weight: 650; line-height: 1; cursor: pointer; }
