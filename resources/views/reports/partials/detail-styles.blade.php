...
/* Report builder */
.report-builder-card { display: grid; gap: 12px; padding: 18px 20px; }
.report-builder-primary { display: grid; grid-template-columns: minmax(230px, 1.1fr) minmax(190px, .8fr) minmax(220px, .9fr); gap: 12px; align-items: start; }
...
.report-builder-actions { display: flex; align-items: flex-start; justify-content: flex-end; flex-wrap: wrap; gap: 12px; }
.report-no-filters { color: var(--text-muted); font-size: 12px; }
.report-generate-button { min-height: 42px; }

.report-more-filters { flex: 1 1 360px; border: 1px solid var(--border); border-radius: var(--radius); background: var(--surface-subtle); }
.report-more-filters > summary { display: flex; align-items: center; gap: 8px; padding: 9px 12px; cursor: pointer; font-size: 12px; font-weight: 700; color: var(--text-secondary); list-style: none; }
