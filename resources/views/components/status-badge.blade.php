...
@php
    ...
    $tone = match (true) {
        ...
        in_array($key, ['RSLDDP_AWAITING_UPLOAD', 'RSLDDP_FOR_ACCOUNTING_PROCESSING', 'RSLDDP_FOR_RESOLUTION', 'COMPLIANCE_RSLDDP_PENDING'], true) => 'info',
        $key === 'RSLDDP_PAYMENT_REQUIRED' => 'warning',
