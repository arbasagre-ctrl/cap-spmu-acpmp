...
class ReportPageTest extends TestCase
{
    ...
    public function test_generated_report_preview_omits_formal_provenance_metadata(): void
    {
        $this->request('ACADEMIC', 'College of Computer Studies');
        ...
        /* Preview stays focused on the report itself; provenance is reserved for print/export. */
        $response->assertDontSee('Prepared by', false);
        $response->assertDontSee('Date Generated', false);
    ...
    public function test_preview_renders_clean_report_without_institutional_masthead(): void
    {
        $this->request('ACADEMIC', 'College of Computer Studies');
        ...
        $response->assertDontSee('Republic of the Philippines', false);
        $response->assertDontSee('CAMARINES SUR POLYTECHNIC COLLEGES', false);
        $response->assertDontSee('Nabua, Camarines Sur', false);
